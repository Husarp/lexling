"""WordGuessSetup.exe - installs, updates and uninstalls the game.
...
Your saves live in %LOCALAPPDATA%\\WordGuess (WebView2's profile, holding the game's localStorage:
