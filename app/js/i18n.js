...
const STR = {
  en: {
    ...
    'lt.tries': 'Tries', 'lt.triesHint': 'fewer tries, more points — unlimited counts every guess twice', 'lt.triesUnit': ['try', 'tries'],
  ...
  pl: {
    ...
    'lt.tries': 'Próby', 'lt.triesHint': 'mniej prób, więcej punktów — bez limitu każda próba liczy się podwójnie', 'lt.triesUnit': ['próba', 'próby', 'prób'],
