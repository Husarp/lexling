...
const STR = {
  en: {
    ...
    'kb.label': 'Keyboard', 'kb.enter': 'Enter', 'kb.backspace': 'Backspace',
    ...
    'lt.tries': 'Tries', 'lt.triesHint': 'fewer tries, more points — unlimited counts as 20', 'lt.triesUnit': ['try', 'tries'],
    ...
    'lt.calc': '{p} letters{double} ÷ {g} {guesses} × 100 × {m} {diff}',
    'lt.calcRandom': '{p} letters{double} ÷ {g} {guesses} × 100 × the random level\'s multiplier',
    'lt.calcTries': ' × {f} ({t})', 'lt.unlimitedLow': 'unlimited',
    'lt.calcLoss': 'best row: {b} of {n} letters right (a yellow counts half) × ¼ of a win on the last try ({w})', 'lt.double': ['({l} counts ×2)', '({l} count ×2)'],
  ...
  pl: {
    ...
    'kb.label': 'Klawiatura', 'kb.enter': 'Enter', 'kb.backspace': 'Cofnij',
    ...
    'lt.tries': 'Próby', 'lt.triesHint': 'mniej prób, więcej punktów — bez limitu liczy się jak 20', 'lt.triesUnit': ['próba', 'próby', 'prób'],
    ...
    'lt.calcRandom': '{p} pkt za litery{double} ÷ {g} {guesses} × 100 × mnożnik wylosowanego poziomu',
    'lt.calcTries': ' × {f} ({t})', 'lt.unlimitedLow': 'bez limitu',
    'lt.calcLoss': 'najlepszy rząd: {b} z {n} liter trafionych (żółta liczy się w połowie) × ¼ wygranej w ostatniej próbie ({w})',
