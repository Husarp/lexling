...
const STR = {
  en: {
    ...
    'cn.polish': 'Polish letters in the circle', 'cn.polishOff': 'None of them will be in the circle.',
    'cn.polishOn': 'They can be in the circle — and in the words on the board.',
    ...
    'lt.polishOn': 'The word may contain them. <em>ż</em> is its own letter — <em>z</em> does not match it.',
    'lt.polishOff': 'The word is guaranteed to have none of them. Turn on for harder words.',
    'lt.marksShort': 'ą–ż',
  ...
  pl: {
    ...
    'cn.polish': 'Polskie litery w kole', 'cn.polishOff': 'W kole nie będzie żadnej z nich.',
    'cn.polishOn': 'Mogą trafić do koła — i do słów na planszy.',
    ...
    'lt.polishOn': 'Słowo może je zawierać. <em>ż</em> to osobna litera — <em>z</em> jej nie trafia.',
    'lt.polishOff': 'Słowo na pewno nie ma żadnej z nich. Włącz, jeśli chcesz trudniejszych słów.',
    'lt.marksShort': 'ą–ż',
