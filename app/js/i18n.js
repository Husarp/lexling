...
const STR = {
  en: {
    ...
    'lt.hintKnown': 'Every letter’s place is known already', 'lt.hintMax': 'No more hints: half the word came from hints already',
  ...
  pl: {
    ...
    'lt.hintKnown': 'Znasz już miejsce każdej litery', 'lt.hintMax': 'Nie ma więcej podpowiedzi: połowa słowa jest już z podpowiedzi',
