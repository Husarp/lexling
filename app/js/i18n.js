...
const STR = {
  en: {
    ...
    'lt.known': 'What you know: letters in place, then letters still to place', 'lt.hintGot': 'Hint · letter {i} is {ch}',
    ...
    'cn.msg.notWord': '“{w}” is not a word', 'cn.msg.already': '“{w}” is already on the board', 'cn.msg.bonusAgain': '“{w}” is already a bonus word',
  ...
  pl: {
    ...
    'lt.known': 'Co już wiesz: litery na miejscu, potem litery do umieszczenia', 'lt.hintGot': 'Podpowiedź · {i}. litera to {ch}',
    ...
    'cn.msg.notWord': 'Nie znam słowa „{w}”', 'cn.msg.already': '„{w}” już jest na planszy', 'cn.msg.bonusAgain': '„{w}” już jest wśród słów bonusowych',
